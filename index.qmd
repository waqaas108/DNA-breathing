...
::: {#fig-Model Comparison layout-ncol=2}
...
#### [Analysis with obsolete data](/gcPBM_obsolete.qmd)
...
## [Acquisition and processing of ChIP-seq sequences and bubble features](/chIPseq.qmd)
#### [Analysis with improperly classified data](/chIPseq_incorrect.qmd)
