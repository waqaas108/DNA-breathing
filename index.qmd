...
## [Phase 3](/phase3page.qmd)

## [Phase 3 redone with simulated data](/phase3page_new.qmd)
...
<figure class="image">
  <img src="figs/phase3/bubble_raw/image.png" alt="Bubble data" style="width:100%">
  <figcaption>Bubble data</figcaption>
  <img src="figs/phase3/bubble_raw/image1.png" alt="Bubble data" style="width:100%">
  <figcaption>Bubble data</figcaption>
  <img src="figs/phase3/bubble_raw/image2.png" alt="Bubble data" style="width:100%">
  <figcaption>Bubble data</figcaption>
...
We used fischer's exact test and linear regressions to compare the effect of a bubble to the effect of a motif in determining binding affinity. We also ran correlation tests between the average flipping feature value for a motif occurrence and the binding affinity of the sequence, and then correlations between the average flipping feature for individual base pair positions and the binding affinity of the sequence.
